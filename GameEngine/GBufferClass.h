...
public:
	...
	void LightPass(DX11& gfx11,RectShape& rect, Camera& camera, std::vector<std::shared_ptr<Light>>& culledShadowLights, std::vector<std::shared_ptr<Light>>& pointLights,float& acceptedDist, RenderTexture& sunShadowTexture);
...
public:
	RenderTexture albedoTexture, normalTexture, metallicRoughnessTexture, worldPositionTexture, depthTexture, specularEmmissionTexture;
	RenderTexture lightPassTexture;
